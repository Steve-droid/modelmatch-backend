# ModelMatch — Runbook & Demo Walkthrough

> A single, reviewer-facing guide to **understand**, **run**, and **demo** ModelMatch. It spans both
...
ModelMatch uses an LLM in **three** places, governed by **where the model runs and whose key pays**:
